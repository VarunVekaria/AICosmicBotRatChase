            ...
            if not move_success or len(self.kbase.poss_locs) == 1:
                if len(self.kbase.poss_locs) == 1:
                    ...
                    while True:
                        ...
                        print(f"ratttttttttttttttttttt is at{self.rat.loc}")
                        self.rat.move_randomly()
                        print(f"ratttttttttttttttttttt is nowwwww at{self.rat.loc}")
                        # Calculate ping probability based on modifyd bot and rat locs
